...
def dataload():
    df = pd.read_csv("C:/Users/Sanjana Mahesh/OneDrive/PES/SEM5/DA/Project_final/Dataset/MER Audio/panda_dataset_taffc_annotations.csv")
    labels = list(df['Quadrant'].unique())
    path_list = []
    quad_list = []
    for i in range(len(df)):
        path = 'C:/Users/Sanjana Mahesh/OneDrive/PES/SEM5/DA/Project_final/Dataset/MER Audio/{}/{}.mp3'.format(df['Quadrant'][i],df['Song'][i])
...
def feature_extraction(df):
    ...
    top100 = pd.read_csv("C:/Users/Sanjana Mahesh/OneDrive/PES/SEM5/DA/Project_final/Dataset/MER Features/top100_features.csv")
